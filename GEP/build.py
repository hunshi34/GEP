...
from GEP.adapter import set_Llama_Adapter, set_Clip_Adapter
...
def create_model(args):
    ...
    set_Llama_Adapter(llama, s=args.adapter_scale, gradient_checkpointing=args.gradient_checkpointing,s1=args.normal_scale)
